      ...
      <section className="video-showcase" id="riding-video" aria-labelledby="video-showcase-title">
        ...
        <div className="vertical-video-card">
          <div className="video-frame">
            <video controls muted loop playsInline preload="none" poster="/assets/banners/generated/zaihai-video-poster-card-352.webp" aria-label="ZAIHAI electric surfboard riding video" width="352" height="466">
