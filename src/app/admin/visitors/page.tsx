    ...
    <AdminShell active="visitors">
      ...
      <section className="admin-panel">
        ...
        <form className="admin-time-filter" action="/admin/visitors" method="get">
          ...
          <label>
            <span>国家</span>
            <input name="country" placeholder="例如 US / Philippines" defaultValue={country} />
          </label>
          <label>
            <span>来源</span>
            <input name="source" placeholder="paid_social / Google" defaultValue={source} />
          </label>
            ...
            <tbody>
              {report.records.length ? report.records.map((record) => (
                <tr key={`${record.time}-${record.customerNo}-${record.page}`}>
                  ...
                  <td>{record.source}</td>
                  <td>{record.sourcePlatform}</td>
                  <td>{record.sourceDetail}</td>
                  <td>{record.page}</td>
